...
import { getHotelById } from "@/store/hotel/action";
...
const HotelSingleV2Dynamic = () => {
  ...
  return (
    <>
      ...
      <StickyHeader2 hotel={hotel.images} />
      {/* End StickyHeader2 */}
          ...
          <div className="row x-gap-40 y-gap-40">
            <div className="col-12">
              ...
              <div className="row x-gap-40 y-gap-40 pt-20">
                <Facilities hotel={hotel.hotel_subfacility}/>
              </div>
              {/* End .row */}
            </div>
            {/* End .col-12 */}
