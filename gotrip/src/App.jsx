...
import ExpertLogin from "./pages/others/expert-login";
import ExpertSignup from "./pages/others/expert-signup/index"
...
import VendorAddTour from "./pages/dashboard/vendor-dashboard/add-tour"
...
import BVVendorTours from "./pages/dashboard/vendor-dashboard/tours/tours";
...
import Mangehotel from "./pages/dashboard/vendor-dashboard/manage-hotel";
          ...
          <Routes>
            <Route path="/">
              ...
              <Route path="vendor-dashboard">
                ...
                <Route path="add-tour" element={<VendorAddTour />} />
                <Route path="booking" element={<VendorBooking />} />
                <Route path="hotels" element={<BVVendorHotel />} />
                <Route path="tours" element={<BVVendorTours/>} />
